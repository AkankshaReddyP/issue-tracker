  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-neutral-950">
      <div className="w-full max-w-md px-7 py-10 bg-neutral-900/90 border border-neutral-800 shadow-xl rounded-lg flex flex-col items-center">
        <h1 className="text-3xl font-bold text-neutral-100 mb-1 tracking-tight">Sign in</h1>
        <p className="mb-8 text-neutral-400 text-xs">to <span className="font-mono text-blue-500 tracking-tight">IssueTracker</span></p>
